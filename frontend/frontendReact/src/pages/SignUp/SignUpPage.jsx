...
const Signup = () => {
  return (
    <main className="flex-1 max-w-7xl mx-auto w-full p-6 lg:p-12 grid lg:grid-cols-2 gap-16 items-center">
      {/* LEFT: form card */}
      ...
      <div className="hidden lg:block relative h-[540px] w-full rounded-[3rem] overflow-hidden shadow-2xl bg-blue-900">
